  ...
  return {
    ...
    arguments: {
      execute: {
        ...
        url: `https://journey-custom-activity-kn.herokuapp.com/modules/discount-code/execute`,
    ...
    configurationArguments: {
      publish: {
        url: `hhttps://journey-custom-activity-kn.herokuapp.com/modules/discount-code/publish`
      },
      validate: {
        url: `https://journey-custom-activity-kn.herokuapp.com/modules/discount-code/validate`
      },
      stop: {
        url: `https://journey-custom-activity-kn.herokuapp.com/modules/discount-code/stop`
      }
    },
    userInterfaces: {
